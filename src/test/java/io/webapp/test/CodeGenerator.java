...
import io.webapp.framework.generator.config.SpringBootPlusMySqlQuery;
import lombok.Data;
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                if (tablePrefix != null && tableName.startsWith(tablePrefix)) {
                    bareTableName = tableName.substring(tablePrefix.length());
                }

                String camelTableName = underlineToCamel(bareTableName);
                String pascalTableName = underlineToPascal(bareTableName);
                String colonTableName = underlineToColon(bareTableName);
